...
// Todoのリストを State（状態）に持ち、Todoを操作するクラスの例
...
// [StateNotifierProvider] 状態を格納し、実装したメソッドを通じて状態を公開・操作できるProvider

// 挿入されるTodoの状態を管理するProviderの作成
...
class StateNotifierProviderPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // StateNotifierProviderを読み取る。watchを使用しているので、state（状態）であるTODOリストが更新されると、buildメソッドが再実行されて画面が更新される
